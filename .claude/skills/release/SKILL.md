...
# Releasing cmem-plugin-csvcombine
...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-csvcombine//actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-csvcombine/).
