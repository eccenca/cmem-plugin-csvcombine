...
from cmem_plugin_csvcombine.transform import Lifetime
from cmem_plugin_csvcombine.workflow import DollyPlugin
from tests.utils import TestExecutionContext, needs_cmem

PROJECT_NAME = "csvcombine_test_project"
...
def setup(request):
    ...
    with io.StringIO("csvcombine plugin sample file.") as response_file:
        create_resource(
            project_name=PROJECT_NAME,
